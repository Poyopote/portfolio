        ...
        <section id="about-section" className="relative py-24 in-the-light max-md:pt-3">
            ...
            <article className="flex flex-col gap-8 lg:flex-row lg:gap-12 md:items-center justify-center mx-auto lg:w-9/12 mb-16">
                ...
                <div className="w-full md:w-8/12 px-4 max-w-2xl max-lg:text-center max-md:px-7">
                    <h2>Steven LADOUR <IdentificationIcon className="h-8 w-8 inline-block" /></h2>
                    <p className="lg:text-2xl font-bold">Concepteur d'interfaces utilisateur axé sur l'accessibilité avec expertise en développement et intégration</p>
                    <br></br>
